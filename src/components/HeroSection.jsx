...
const HeroSection = ({children}) => {
  return (
    <section className='bg-[#f2f2f20a] outline-1 outline-[rbga(242,242,242,0.05)] shadow-[0_40_80_rgba(0,0,0,0.5)] w-full lg:w-4/5 h-full sm:min-h-[80%] rounded-2xl window-outline'>
