...
const HeroSection = ({ children }) => {
  ...
  return (
    <section
      data-aos="fade-up"
      className="bg-[#f2f2f20a] outline-1 outline-[rbga(242,242,242,0.05)] shadow-[0_40_80_rgba(0,0,0,0.5)] w-full lg:w-4/5 max-h-full sm:min-h-[80%] rounded-2xl window-outline"
    >
        ...
        <div className="window-bar">
          ...
          {clicked && (
            <p className="text-black text-xs sm:text-sm">
              Oops! This close button doesn't work.
