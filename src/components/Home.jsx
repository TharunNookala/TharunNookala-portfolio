...
const Home = () => {
    ...
    return (
        <div name="home" className='h-screen text-white py-4 px-4 flex flex-col'>
            ...
            <Link to="/assignments" className="text-white w-[200px] border text-xl font-semibold hover:bg-white hover:text-[#ff7b9e] hover:scale-110 md:my-1 mx-auto md:mx-0 py-2 text-center rounded-md md:ml-3 animate-pulse">
                Assignments &rarr;
            </Link>
            </div>
