        ...
        <div name="about" className="w-full md:h-screen rounded-lg flex flex-col md:flex-row items-center justify-center p-4">
            <div className=' py-2 my-2 mx-4 border-2 rounded-lg' data-aos='fade-up'>
                <p className='md:text-2xl text-[15px] md:font-semibold md:w-[400px] text-white p-4'>
                    ...
                    Tailwind CSS which are the most used tech stack for beautiful responsive UI websites built today.Also I have built myself few projects using these. I am also Full Stack(MERN)
                    enthusiast. Out of Office you'll find me spending time with friends, binge watching movies, playing badminton, less-often reading books. Currently learning Mongo DB, Express JS,
                    Node JS.
                </p>
            </div >
            <div className='p-4 md:max-w-[600px]'>
                <div className="p-4 bg-white rounded-lg shadow-lg my-2">
                    ...
                    <ul className="list-disc pl-6">
                        <li>Worked on technologies such as HTML5, CSS, JavaScript, React for developing various websites.</li>
                        <li>Created new features, functionality and capabilities on the e-commerce sites using React and managed state
                            using react-redux.
                        </li>
